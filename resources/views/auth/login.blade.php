		...
		<div class="login-container">
			...
			<div class="login-header">
				<div class="brand">
					...
					<img src="{{url('/web/assets/img/matix/logo-white.png')}}" alt="user_profile" width="250px">
				</div>
				<div class="icon">
			...
			<div class="login-content">
                <form method="POST" action="{{ route('login') }}">
					...
					<div class="form-floating mb-20px">
						<input id="email" type="email"  class="form-control fs-13px h-45px border-0 form-control @error('email') is-invalid @enderror"  name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email Address" />
					...
					<div class="form-floating mb-20px">
						<input id="password" type="password" class="form-control fs-13px h-45px border-0 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password" />
