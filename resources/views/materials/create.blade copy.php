    ...
    <div class="panel panel-inverse">
        <div class="panel-body" id="pannel-body">
            <div class="row mb-3" style="margin: 0px;">
                <div class="col-12 row g-0" style="margin: 0px; padding: 0px;">
            ...
            <div class="col-12 mt-3">
                <label for="material_description">Description <span class="text-danger">*</span></label>
                <div class="border">
            ...
            <div class="col-12 mt-3">
                <div>
                    <table class="properties_table table table-responsive" id="properties_table">
                        <thead class="table-light">
                            <tr>
                                <th>Properties</th>
                                <th></th>
                                <th class="col-span-2" style="text-align: right;"><button style="width: 50px" type="button"
                                        id="addRowBtnRoles" onclick="addPropertyRow()" class="btn btn-primary btn-xs"><i
                                            class="fa fa-add"></i>
                                    </button></th>
                            </tr>
                        </thead>
                        <tbody id="properties_tableBody">
                            <tr>
                                <td style="width:50%">
                                    <div>
                    ...
                    <table class="technical_properties_table table table-responsive" id="technical_properties_table">
                        <thead class="table-light">
                            <tr>
                                <th>Technical Properties</th>
                                <th></th>
                                <th class="col-span-2" style="text-align: right;"><button style="width: 50px" type="button"
                                        id="addRowBtnRoles" onclick="addTechnicalPropertyRow()"
                    ...
                    <table class="sustainability_table table table-responsive" id="sustainability_table">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th></th>
                                <th class="col-span-2" style="text-align: right;"><button style="width: 50px" type="button"
                                        id="addRowBtnRoles" onclick="addSustainabilityRow()"
                                        class="btn btn-primary btn-xs"><i class="fa fa-add"></i>
                                    </button></th>
                            </tr>
                        </thead>
