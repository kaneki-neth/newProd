...
<h1 class="page-header">Material (View)</h1>

<div class="panel panel-inverse">
    <div class="panel-body" id="pannel-body" style="padding: 45px !important;">
        <div class="d-flex justify-content-start gap-2">
            <button class="btn btn-primary btn-xs" type="submit" onclick="location.href='/material'">
                <i class="fa fa-arrow-left"></i>
                Back
            </button>
            @can('material-write')
            <button class="btn btn-primary btn-xs" type="submit" onclick="location.href=`/material/{{$material->m_id}}/edit`">
                ...
                <div class="col-8 mt-3">
                    <div class="row">
                        <div class="col">
                            ...
                            <div style="background: #e7e7e7;" class="form-control form-control-sm">
                                {{ $material->name}}
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <div style="background: #e7e7e7;" class="form-control form-control-sm">
                                ...
                                <span class="badge" style="background-color: #bbb">{{ $category->name }}</span>
                                @endif
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="row g-0 mt-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="bg-secondary form-check-input" type="checkbox" role="switch" id="enabled" name="enabled" {{$material->enabled ? 'checked' : ''}}
                                onclick="return false;" onkeydown="return false;"
                                style="pointer-events: none; border-color: #6c757d;">
                        </div>
                    </div>
                    ...
                    <div class="row mt-3 g-0">
                        ...
                        <div class="border form-control form-control-sm" style="pointer-events: none; background: #e7e7e7; border-radius: 4px; height: 350px; overflow: auto;">
                            @php
                    ...
                    <div class="row g-0 mt-3">
                        <div class="col-12">
                            <div>
                                <table class="properties_table table table-responsive" style="border-radius: 4px;">
                                    <thead class="table-light">
                                        <tr>
                ...
                <div class="col-4 d-flex align-items-end flex-column" style="height: 100%">
                    <div class="row g-0">
                        <div class="col-9" style="margin-left: auto">
                            ...
                            <div class="w-100 overflow-hidden ratio ratio-1x1" style="border:1px solid #ddd; margin-left: 0 !important; margin-right: 0 !important;"
                                class="row g-0">
                                <img class="w-100 h-100 object-fit-cover opacity-75" src="{{ asset('storage').'/'.$material->image_file}}" id="mainImage">
                            </div>
                            @if (count($images) > 0)
                            <div id="imageGallery"
                                style="display: flex; gap: 10px; overflow-x: auto; padding: 5px; border: 1px solid #ddd; margin-top: 8px">
                                @foreach ($images as $image)
                                <div class="image-container">
                                    <img class="preview-image opacity-75" src="{{ asset('/storage' . '/' . $image->image_file) }}">
                                </div>
                                @endforeach
                            </div>
                            @endif
