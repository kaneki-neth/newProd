            ...
            <div class="d-flex justify-content-start gap-2">
                ...
                @can('material-write')
                    <button class="btn btn-primary btn-xs" type="submit"
                        onclick="location.href=`/material/{{$material->m_id}}/edit`">
                    ...
                    <div class="col-8 mt-3">
                        ...
                        <div class="row g-0 mt-3">
                            ...
                            {{-- <div class="form-check form-switch">
                                <input class="bg-secondary form-check-input" type="checkbox" role="switch" id="enabled"
                                    name="enabled" {{$material->enabled ? 'checked' : ''}} onclick="return false;"
                                onkeydown="return false;" style="pointer-events: none; border-color: #6c757d;">
                            </div> --}}
                        </div>
                        ...
                        <div class="row mt-3 g-0">
                            ...
                            <div class="border form-control form-control-sm"
                                style="pointer-events: none; background: #e7e7e7; border-radius: 4px; height: 350px; overflow: auto;">
                                @php
                        ...
                        <div class="row g-0">
                            <div class="col-9" style="margin-left: auto">
                                ...
                                <div class="w-100 overflow-hidden ratio ratio-1x1"
                                    style="border:1px solid #ddd; margin-left: 0 !important; margin-right: 0 !important;"
                                    class="row g-0">
                                    <img class="w-100 h-100 object-fit-cover opacity-75"
                                        src="{{ asset('storage') . '/' . $material->image_file}}" id="mainImage">
                                </div>
                                @if (count($images) > 0)
                                    <div id="imageGallery"
                                        ...
                                        @foreach ($images as $image)
                                            <div class="image-container">
                                                <img class="preview-image opacity-75"
