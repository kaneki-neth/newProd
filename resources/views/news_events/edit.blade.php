    ...
    <div class="panel-body" id="pannel-body">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-start gap-2">
                <a href="/news_events/{{ $news_event->ne_id }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View</a>
            </div>
        </div>
        <div class="row mt-3">
        ...
        <div class="mt-3 d-flex flex-row gap-2">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" id="enabled" name="enabled" {{ $news_event->enabled ? 'checked' : '' }}>
            </div>
        </div>
