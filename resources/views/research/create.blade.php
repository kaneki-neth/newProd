...
@section('content')
    ...
    <ol class="breadcrumb float-xl-end">
        <li class="breadcrumb-item"><a href="{{ route('research.index') }}">Researches</a></li>
        <li class="breadcrumb-item"><a href="javascript:;">Add Research</a></li>
    </ol>
    <h1 class="page-header">Add Research</h1>

    <div class="panel panel-inverse">
        <div class="panel-body" id="pannel-body">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-start gap-2">
                    <a href="{{ route('research.index') }}" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i>
                        Back</a>
                </div>
            </div>
            <div class="row mt-3">
                ...
                <div id="images" class="col-md-5">
                    ...
                    <div class="col-md-5 mt-3 d-flex flex-row justify-content-end gap-2">
    ...
    <script>
        ...
        function submitData() {
            ...
            document.querySelectorAll('#authors_tableBody tr').forEach((row, index) => {
                let name = row.querySelector('input[name="author_name"]').value;
                if (name) {
                    authors.push(name);
            ...
            // Properly handle multiple file uploads
            ...
            // Log the FormData payload to check if the file is being passed
