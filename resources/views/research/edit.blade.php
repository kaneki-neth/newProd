            ...
            <div class="row mt-3">
                <div id="fields" class="col-md-7">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <span class="text-uppercase small text-muted">maximum file size: 100MB</span> <span
                            class="text-danger small">*</span>
                        <span id="uploadFiles-msg" class="error-msg text-danger"></span>
                    </div>
                ...
                error: function (xhr, status, error) {
                    if (xhr.status === 413) {
                        ...
                        Swal.fire({
                            ...
                            html: 'The contents are too large!<br>Please select a file that is 100MB or under.',
