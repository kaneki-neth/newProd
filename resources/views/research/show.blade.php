        ...
        <div class="row mt-3">
            ...
            <div class="col-md-5">
                <div class="d-flex flex-column mx-auto" style="max-width: 80%">
                    <div id="main-img-container" class="opacity-75 img-thumbnail d-flex justify-content-center align-items-center">
                        <img src="{{ asset('storage/'.$research->image_file) }}" alt="Image" style="width: 100%; height:100%; object-fit: contain;">
                    </div>
                        ...
                        <div id="imageGallery" style="display: flex; gap: 10px; overflow-x: auto; padding: 5px; border: 1px solid #ccc; border-radius: 4px; margin-top: 8px">
                            @foreach($subImages as $subImage)
                                <div class="image-container">
                                    <img class="opacity-75" src="{{ asset('storage/'.$subImage->image_file) }}" style="width: 100%; height: 100%; border: 1px solid #d1c3c0">
                                </div>
                            @endforeach
                        </div>
                    @endif
