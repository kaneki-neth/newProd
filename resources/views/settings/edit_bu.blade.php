<form id="form-company-business-unit-edit" autocomplete="off">
    <div class="row p-1">
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="position:relative">
                    <input onkeyup="remove_error(this)" type="text" value="{{$combusunit->bu_code}}" name="bu_code" id="bu_code" value="" class="form-control form-control-sm mb-5px" placeholder="BU Code">
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="position:relative">
                <input onkeyup="remove_error(this)" type="text" value="{{$combusunit->bu_name}}" id="bu_name" name="bu_name" value="" class="form-control form-control-sm mb-5px" placeholder="BU Name">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                <input type="text" id="bu_tel_num" name="bu_tel_num" value="{{$combusunit->tel_num}}" value="" class="form-control form-control-sm mb-5px" placeholder="Telephone Number">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="position:relative">
                <input onkeyup="remove_error(this)" type="text" value="{{$combusunit->address_line1}}" id="bu_address_line1" name="bu_address_line1" value="" class="form-control form-control-sm mb-5px" placeholder="Address 1">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                <input type="text" id="bu_address_line2" value="{{$combusunit->address_line2}}" name="bu_address_line2" value="" class="form-control form-control-sm mb-5px" placeholder="Address 2">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="position:relative">
                <input onkeyup="remove_error(this)" type="text" id="bu_city" value="{{$combusunit->city}}" name="bu_city" value="" class="form-control form-control-sm mb-5px" placeholder="City">
            ...
            <div class="row">
                ...
                <div class="col-md-9" style="position:relative">
                <input onkeyup="remove_error(this)" type="text" id="bu_province" value="{{$combusunit->province}}" name="bu_province" value="" class="form-control form-control-sm mb-5px" placeholder="Province">
            ...
            <div class="row">       
                ...
                <div class="col-md-9" style="position:relative">
                <input onkeyup="remove_error(this)" type="text" id="bu_postal_code" value="{{$combusunit->postal_code}}" name="bu_postal_code" value="" class="form-control form-control-sm mb-5px" placeholder="Postal Code">
                <span id="bu_postal_code-msg" class="text-danger" style="left: 19px; position: absolute; bottom: 2px; background: white; line-height: 9px; "></span>
                </div>
            </div>
            <div class="row">
                <label class="form-label col-form-label col-md-3">Country <span style="color:red">*</span></label>
                <div class="col-md-9" style="position:relative">
                <input onkeyup="remove_error(this)" type="text" id="bu_country" name="bu_country" value="{{$combusunit->country}}" value="" class="form-control form-control-sm mb-5px" placeholder="Country">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="enabled"  name="enabled" <?php if($combusunit->enabled === 1){echo "checked";}?> >
...
<script>
    ...
    $('#form-company-business-unit-edit').submit(function(e) {
            e.preventDefault();
			$(".btn").attr("disabled", true);
            let formData = new FormData(this);
            formData.append('_token', `{{ csrf_token() }}`);
            formData.append('_bu', `{{ $combusunit->bu_id }}`);
            formData.set('enabled', $('#enabled').is(':checked') ? 1 : 0);
            $.ajax({    
                method: 'post',
                url: '/settings/company/bu/store_update',
                data: formData,
                contentType: false,
                processData: false,
                success: (response) => { 
