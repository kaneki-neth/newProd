            ...
            <div class="col-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-sm" id="datepicker-autoClose" name="date"
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <input class="form-control form-control-sm" name="video_url" id="urlInput" placeholder="Paste video URL here"
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div id="description-container" class="border" style="border-radius: 4px">
                            <textarea class="textarea form-control form-control-sm" name="description" id="summernote"
                                placeholder="Enter text ..." rows="12"></textarea>
                        </div>
                    </div>

                    <!-- Submit Button -->
                    <div class="mt-5 col-12 d-flex justify-content-start mt-3">
