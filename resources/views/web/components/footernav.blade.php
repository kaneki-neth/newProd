      ...
      <div class="row gy-4">
        <div class="col-lg-3 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <img src="web/assets/img/matix/logo-white.png" data-aos="fade-in">
          </a>
        </div>
        ...
        <div class="col-lg-4 col-md-12">
            <img src="web/assets/img/matix/footerlogo1.png" data-aos="fade-in" style="width: 139px;">
            <img src="web/assets/img/matix/dti.png" data-aos="fade-in" style="width: 77px;">
            <img src="web/assets/img/matix/tatapinoy.png" data-aos="fade-in" style="width: 117px; margin-top: 34px; ">
        </div>
