        ...
        <div class="row">
          ...
          <div class="hero-sum-img1 col-6 col-md-3" data-aos="fade-up" data-aos-delay="100">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico1.png" class="img-fluid" style="width: 60%;">
            </div>
            <div class="text-center">
          ...
          <div class="hero-sum-img2 col-6 col-md-3" data-aos="fade-up" data-aos-delay="200">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico2.png" class="img-fluid" style="width: 50%;">
            </div>
            <div class="text-center">
          ...
          <div class="hero-sum-img3 col-6 col-md-3" data-aos="fade-up" data-aos-delay="300">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico3.png" class="img-fluid" style="width: 50%;">
            </div>
            <div class="text-center">
          ...
          <div class="hero-sum-img4 col-6 col-md-3" data-aos="fade-up" data-aos-delay="400">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico4.png" class="img-fluid" style="width: 35%; margin-top: 18px;">
            </div>
            <div class="text-center">
              <p class="hero-sum-title dmsans-semi-bold mb-0" style="font-size: 20px; margin-top: 18px;">Sustainability & creativity</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="100">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico1.png" class="img-fluid" style="max-width: 40%;">
            </div>
          ...
          <div class="col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="200">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico2.png" class="img-fluid" style="max-width: 40%;">
            </div>
            <div class="text-center mt-3">
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="300">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico3.png" class="img-fluid" style="max-width: 40%;">
            </div>
            <div class="text-center mt-3">
          ...
          <div class="col-md-6 d-flex flex-column align-items-center" data-aos="fade-up" data-aos-delay="400">
            <div class="text-center">
              <img src="web/assets/img/img_ico/img_ico4.png" class="img-fluid mt-3" style="max-width: 30%;">
            </div>
            <div class="text-center mt-3">
        ...
        <div class="row gy-4">
          <div class="about-right col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100" style="padding-left: 60px; border-left: 1px solid gray;">
            ...
            <div class="about-new owl-carousel">
                <div class="item">
                    ...
                    <img src="web/assets/img/matix/about-img.png" class="img-fluid">
                </div>
        
                <div class="item">
                    <h3 class="dmsans-regular mt-4"><strong>MATIX launches new space at FabLab</strong></h3>
                    <p class="dmsans-regular">Posted 16 Nov 2025</p>
                    <img src="web/assets/img/matix/about-img-1.png" class="img-fluid">
                </div>
        
                <div class="item">
                    <h3 class="dmsans-regular mt-4"><strong>Workshop for organic textiles in Argao</strong></h3>
                    <p class="dmsans-regular">Posted 16 Nov 2025</p>
                    <img src="web/assets/img/matix/about-img-2.png" class="img-fluid">
                </div>
            </div>
          ...
          <div class="about-left col-lg-6 order-2 order-lg-1 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200" style="border-right: 1px solid gray; padding-right: 60px;">
            <div>
              ...
              <a href="#" class="read-more mt-3"><span class="arial_narrow_7">Learn More</span></a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 d-flex justify-content-between">
            ...
            <a href="#" class="arial_narrow_7 c-black">Go to digital archives</a>
          </div>
          <div class="slides col-12 mt-5">
            <div class="materials owl-carousel owl-theme">
              <div class="item">
                <div style="width: 80%;">
                  <img src="web/assets/img/matix/materials/7bdde-polyem-thick-rotex 1.png" class="">
                </div>
                <div>
              ...
              <div class="item">
                <div style="width: 80%;">
                  <img src="web/assets/img/matix/materials/image-mat-2.png" class="">
                </div>
                <div>
                  <h6 class="dmsans-semi-bold mt-3 mb-2">Abaca + Bacbac Mat #125</h6>
                  <div style="height: 40px;">
              ...
              <div class="item">
                <div style="width: 80%;">
                  <img src="web/assets/img/matix/materials/polyem.png" class="">
                </div>
                <div>
              ...
              <div class="item">
                <div style="width: 80%;">
                  <img src="web/assets/img/matix/materials/image.png" class="">
                </div>
                <div>
